...
- A deterministic server-side idle renderer produces a large `HH:MM` seven-segment clock over a slowly evolving ordered-pattern field for a fixed UTC minute, width, height, and dither mode.
